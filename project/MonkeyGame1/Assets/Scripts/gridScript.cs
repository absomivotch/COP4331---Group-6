...
public class gridScript : MonoBehaviour
{
    ...
    public GameObject hexPrefab, hexGrid, selectedCharacter, gameCamera, moveButton, gridObject;
...
*/
    ...
    public void MoveCurrentCharacter(int x, int y)
    {
        ...
        playerSelect tmp1 = gameCamera.GetComponent<playerSelect>();
        gridObject = GameObject.Find("GridMap");

        if(tmp1.currentCharacter == "A"){
            selectedCharacter = GameObject.Find("player1SlotA");
            Debug.Log("selected A");
        }
        else if(tmp1.currentCharacter == "B"){
