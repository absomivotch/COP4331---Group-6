...
|14b - ART | As a player, I want to see a yellow crossbow in the game. | Open the unity project, open the assets folder and go to Weapons>Object. | Inside, there should be a model of a yellow crossbow.
|15c - ART | As a player, I want to see a barrel in the game. | Open the unity project, open the assets folder and go to Environment>Barrel. | Inside, there should be a model of a barrel visible.
