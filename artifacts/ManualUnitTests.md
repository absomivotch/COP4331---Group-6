...
|27c - PGM | As a player, I want my character to move from its old position to the 'target space' once the 'target space' has been confirmed. | Go to move mode, click a space to move, see if the character that was selected moves to that space or not. |
